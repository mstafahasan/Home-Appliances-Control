...
//! \param pui8HubPool is the memory pool allocated to the USB hub class.
//! \param ui32PoolSize is the size in bytes of the memory pool provided by the
//! \e pui8HubPool parameter.
//! \param psHubInstance is a pointer to an instance of the private hub data.
//! \param ui32NumHubs is the number of hubs to support.
//!

...
//*****************************************************************************
static void
Internai32ImageDraw(const tContext *pContext, const uint8_t *pui8Image,
...
GrTransparentImageDraw(const tContext *pContext, const uint8_t *pui8Image,
                       int32_t i32X, int32_t i32Y, uint32_t ui32Transparent)
{
    Internai32ImageDraw(pContext, pui8Image, i32X, i32Y, ui32Transparent,
                        true);
}
...
{
    Internai32ImageDraw(pContext, pui8Image, i32X, i32Y, 0, false);
}
